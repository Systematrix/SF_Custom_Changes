		...
		for item in sorted(iwb_map[company]):
			for wh in sorted(iwb_map[company][item]):
				...
				data.append([item, item_map[item]["item_name"],wh,
					item_map[item]["stock_uom"],item_map[item]["weight_uom"],qty_dict.opening_qty,
...
def get_item_details(filters):
	item_map = {}
	for d in frappe.db.sql("select name, item_name, stock_uom, weight_uom, last_purchase_rate, item_group, brand, \
